	...
	if row.Err() == nil {
		...
		if err == nil {
			for lineRows.Next() {
				...
				err = lineRows.Scan(&ps.Quantity, &ps.Product.ID, &ps.Product.Name, &ps.Product.Description,
